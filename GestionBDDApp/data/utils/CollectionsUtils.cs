...
namespace GestionBDDApp.data.utils
{
    ...
    public class CollectionsUtils
    {
        ...
        /// <paramref name="Dictionary"/>, si aucune valeur n'est trouvée pour cette clé dans le dictionnaire, une
        /// valeur par défaut fourni par le <paramref name="DefaultValueProvider"/> est placée dans le dictionnaire
        /// avec cette clé et est renvoyée. 
        /// </summary>
