...
namespace GestionBDDApp.data.utils
{
    ...
    public class CollectionsUtils
    {
        ...
        /// <paramref name="Dictionary"/>, si aucune valeur n'est trouvé pour cette clé dans le dictionnaire, une
        /// valeur par défaut fournis par le <paramref name="DefaultValueProvider"/> est placé dans le dictionnaire
        /// avec cette clé et est renvoyé. 
        /// </summary>
